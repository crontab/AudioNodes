...
open class Recorder: Monitor, @unchecked Sendable {
...
open class FileRecorder: Recorder, @unchecked Sendable {
...
open class MemoryRecorder: Recorder, @unchecked Sendable {
